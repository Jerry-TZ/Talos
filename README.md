...
**一个你能完整读完的编程 agent。** 2366 行 Python,102 个离线测试,一份不糊弄人的安全说明。
...
- **能验证** — 102 个测试,**离线、免 API key、1 秒跑完**,CI 在 Linux/Windows × Python 3.10/3.13 上都跑。clone 下来立刻知道它没坏。
