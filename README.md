...
**一个你能完整读完的编程 agent。** 4091 行 Python,226 条离线判据,一份不糊弄人的安全说明。
...
- **能验证** — 226 个测试,**离线、免 API key、几秒跑完**,CI 在 Linux/Windows × Python 3.10/3.13 上都跑。clone 下来立刻知道它没坏。
...
.venv\Scripts\python.exe -m pytest tests/ -q     # 226 条,约 8 秒,不联网、不需要 key
